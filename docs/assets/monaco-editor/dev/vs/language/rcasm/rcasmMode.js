 ...
 *-----------------------------------------------------------------------------*/
define("vs/language/rcasm/rcasmMode", ["require"],(require)=>{
"use strict";
var moduleExports = (() => {
  ...
  var rcasmMode_exports = {};
  __export(rcasmMode_exports, {
  ...
  // src/language/rcasm/workerManager.ts
  ...
  return __toCommonJS(rcasmMode_exports);
})();
